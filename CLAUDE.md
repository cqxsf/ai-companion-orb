...
| 2026-03-13 | V9 外形 Ø112mm × H86mm (H/W=0.77) | 连续椭球体消除拼接感，蛋形「桌面情绪物件」|
| 2026-03-13 | 浮岛式顶盖 Ø92mm + 0.6mm 缝隙 | 缝隙兼做麦克风孔和灯光溢出口=AI「呼吸口」|
| 2026-03-13 | 隐藏式灯环 4mm 磨砂 PC 扩散罩 | 光从内部自然透出，无「拼接灯带」感 |
| 2026-03-13 | 5 件式装配（顶盖/上壳/灯环/下壳/底盖）| M2×6 螺丝 ×4 + 卡扣，简化装配 |
| 2026-03-13 | FreeCAD 参数化建模（兼容 OpenSCAD）| 工业设计级可修改参数工程 |
